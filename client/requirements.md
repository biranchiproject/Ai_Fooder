## Packages
framer-motion | Page transitions, micro-interactions, and premium UI animations
clsx | Conditional class name joining for utility components
tailwind-merge | Merging tailwind classes to avoid conflicts
