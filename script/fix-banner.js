    ...
    return (
        <section className="mb-12">
            <motion.div
                ...
                onClick={handleClick}
                className="relative cursor-pointer py-12 px-6 group flex flex-col items-center justify-center text-center rounded-[2.5rem] border border-primary/20 bg-primary/5 backdrop-blur-sm overflow-hidden min-h-[400px]"
            >
                {/* Background Glows */}
                <motion.div
                ...
                <div className="space-y-6 max-w-3xl mx-auto z-10">
                    ...
                    <motion.h2
                        className="text-4xl sm:text-6xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-[#ff0080] via-[#7928ca] to-[#0070f3] leading-tight"
                        animate={{
                            opacity: [0.9, 1, 0.9],
                            scale: [1, 1.01, 1]
                        }}
...
`;
fs.writeFileSync('c:/Users/biran/Downloads/Food-Delivery-Hub/Food-Delivery-Hub/client/src/components/AIPromoBanner.tsx', content);
